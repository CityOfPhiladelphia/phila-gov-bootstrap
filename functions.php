...
//insall required plugins and such
...
add_action( 'tgmpa_register', 'phila_register_required_plugins' );
/**
 ...
 */
function phila_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Phila General Functionality Plugin', // The plugin name.
            'slug'               => 'phila_general', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/library/plugins/phila_general.zip', // The plugin source.
        ...
        array(
            'name'               => 'Phila News Functionality Plugin', // The plugin name.
            'slug'               => 'phila_news', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/library/plugins/phila_news.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
    ...
    $config = array(
        ...
        'menu'         => 'phila-install-plugins', // Menu slug.
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'phila' ),
            'menu_title'                      => __( 'Install Plugins', 'phila' ),
            'installing'                      => __( 'Installing Plugin: %s', 'phila' ), // %s = plugin name.
